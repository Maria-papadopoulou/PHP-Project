            ...
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm">
                ...
                <div class="card-body">
					...
					<button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseExample<?php echo $row['id']; ?>" aria-expanded="false" aria-controls="collapseExample">
						Actors
						</button>
				...
				<?php
					...
					?>
					<br/>
					<button type="button" class="btn btn-outline-secondary"><?php echo $row2['name']." ".$row2['surname']; ?></button>
